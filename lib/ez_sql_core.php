<?php
	...
	if (strstr( $_SERVER['PHP_SELF'],'ez_sql_core.php')) die('You are not allowed to see this page directly');
	...
	*/
	...
	// @edit 2018-12-21; PHP7.3 Fix: 'Deprecated: define(): Declaration of case-insensitive constants is deprecated'
	...
	class ezSQLcore
	{
		...
		*/
        ...
        function debug_log()
        {
            ...
            global $user;
            /**
             *  || stristr($this->last_query,"language_article")
            || stristr($this->last_query,"language_repore")
             *
             */
            //Nur durchlaufen bei bestimmten Tabellen
            if (stristr($this->last_query,"lookup_art_cat") && stristr($this->last_query,"version"))
            {
                if (stristr($this->last_query,"SELECT"))
                {
                    return false;
                }
