...
$this->content->template['message_416'] = "Markdown Editor (Attenzione: con la conversione tra Markdown e HTML, gli attributi HTML che Markdown non può mappare vanno persi. Gli elementi HTML che non possono essere mappati non vengono persi, ma rimangono).";
