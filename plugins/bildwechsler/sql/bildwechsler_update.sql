...
ALTER  TABLE `XXX_bildwechsler` ADD `bw_text` text default NULL; ##b_dump##
ALTER  TABLE `XXX_bildwechsler` ADD `bw_noch_mehr_text` text default NULL; ##b_dump##
ALTER  TABLE `XXX_bildwechsler` ADD `bw_lang_id` int(11) default NULL; ##b_dump##
ALTER  TABLE `XXX_bildwechsler` ADD `bw_extra_link` text default NULL; ##b_dump##
ALTER  TABLE `XXX_bildwechsler` ADD `bw_extra_link_text` text default NULL; ##b_dump##
