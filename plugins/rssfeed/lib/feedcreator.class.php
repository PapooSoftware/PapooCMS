...
//		debug::print_d($this->content); exit;
		...
		$feed.= "        <link>".$this->link."</link>\n";
		$feed.= "        <atom:link href=\"http://" . $this->content->template['site_name'] . $this->content->template['webverzeichnis'] . "plugins/rssfeed/feed" . $this->content->template['rss_lang_id'] . ".xml\" rel=\"self\" type=\"application/rss+xml\" />\n";
		$now = new FeedDate();
