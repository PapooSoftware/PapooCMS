...
{
	/**
	 * leadtracker_follow_up_mails constructor.
	 */
	...
	function manage_admin()
	{
		...
		if (!empty($this->checked->leadtracker_fum_id)) {
			...
			if (isset($this->checked->is_eingetragen) && $this->checked->is_eingetragen=="ok") {
	...
	function set_ids_der_follow_daten()
	{
		...
		if (isset($this->checked->leadtracker_fum_id) && !is_numeric($this->checked->leadtracker_fum_id)) {
		...
		if (!empty($this->checked->submit_follow_up_mail)) {
			if($checkdata = $this->get_check_replace_fields()) {
				if($this->checked->leadtracker_checkreplace_activate) {
					...
					$this->checked->leadtracker_checkreplace = NULL;
				}
