...
$this->content->template['news_message_1']="<h1>Newsletter bearbeiten</h1><p>Sie können hier den Newsletter bearbeiten, Abbonenten bearbeiten und das Impressum.</p><p>Wenn sie den Newsletter einbinden möchten, dann können sie:<br/><ol><li>Einen Menüpunkt erstellen. Bei der Erstellung können Sie von Hand unter \"Einbindung des Links oder der Datei.\" den folgenden Eintrag hinzufügen: plugin:Newsletter/templates/subscribe_newsletter.html.</li><li>Wenn Sie keinen eigenen Menüpunkt haben wollen, können Sie in jedem beliebigen Artikel einen Link erstellen durch die Linkfunktion im Editor. Der Link sollte den folgenden Inhalt haben: /plugin.php?menuid=1&template=../plugins/Newsletter/templates/subscribe_newsletter.html .</li></ol>";
