window.bioEp = {
    ...
    checkCookie: function() {
        ...
        // Handle cookie reset
        if(this.cookieExp <= 0) {
            this.cookieManager.erase(this.cookie_name);
            return false;
        }

        // If cookie is set to true
        if(this.cookieManager.get(this.cookie_name) == "true")
            return true;

        // Otherwise, create the cookie and return false
        this.cookieManager.create(this.cookie_name, "true", this.cookieExp);
    ...
    addCSS: function() {
        ...
        var css = document.createTextNode(
            ...
            "#bio_ep_close {position: absolute; left: 100%; margin: -8px 0 0 -12px; width: 25px; height: 25px; color: #fff; font-size: 13px; font-weight: bold; text-align: center; border-radius: 50%; padding-top:5px; background-color: #333; cursor: pointer;}" +
            this.css
        );
    ...
    setOptions: function(opts) {
        ...
        this.cookie_name = (typeof opts.cookie_name === 'undefined') ? this.cookie_name : opts.cookie_name;
