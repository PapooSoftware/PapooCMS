...
ALTER TABLE `XXX_papoo_form_manager` ADD `form_manager_mail_settings_type` varchar(255) NOT NULL DEFAULT 'system'; ##b_dump##
ALTER TABLE `XXX_papoo_form_manager` ADD `form_manager_smtp_host` varchar(255) NOT NULL DEFAULT ''; ##b_dump##
ALTER TABLE `XXX_papoo_form_manager` ADD `form_manager_smtp_prefix` tinyint(1) NOT NULL DEFAULT 1; ##b_dump##
