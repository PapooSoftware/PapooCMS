...
'<p>Die Einbindung des Frontend-Templates geht wie folgt:
	Erstelle einen neuen Menü-Punkt. Gebt dort unter formlink (ganz unten) Folgendes ein: <strong>plugin:test/templates/test_front.html</strong>. Damit steht das Template im Frontend zur Verfügung.</p>'.
