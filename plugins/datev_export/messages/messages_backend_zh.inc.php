...
$this->content->template['plugin_test__datev_export'] = "数据文件出口"; 
$this->content->template['plugin_test__exportieren_sie_hier'] = "在这里为Datev导出您的网上商店的发票数据。选择时间范围，然后点击导出。然后会生成一个csv文件，你可以下载并导入Datev。"; 
