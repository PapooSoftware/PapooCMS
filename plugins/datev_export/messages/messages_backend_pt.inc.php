...
$this->content->template['plugin_test__datev_export'] = "Datav exportação"; 
$this->content->template['plugin_test__exportieren_sie_hier'] = "Exporte os dados da factura da sua loja online para a Datev aqui. Selecione o período de tempo e depois clique em Exportar. Depois é gerado um arquivo csv que você pode então baixar e importar para o Datev."; 
