...
$this->content->template['plugin_test__datev_export'] = "Esportazione datav"; 
$this->content->template['plugin_test__exportieren_sie_hier'] = "Esporta qui i dati delle fatture del tuo negozio online per Datev. Seleziona l'arco di tempo e poi clicca su Esporta. Poi viene generato un file csv che puoi poi scaricare e importare in Datev."; 
